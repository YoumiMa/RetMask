...
def main():
    ...
    print("=" * 80)
    print(f"Dataset columns right before DPOTrainer: {dataset.column_names}")
    print(f"First example: {dataset[0]}")
    print("=" * 80)
    
    if dpo_training_args.eval_data_files:
        eval_dataset = load_dpo_datasets(dpo_training_args.eval_data_files)
    ...
    args=dpo_config,  # training configs
    ...
    #     sample_ids = first_batch['input_ids'][0][:100]  # first 100 tokens
